...
public class FragmentElectivesixtyone extends Fragment {
    View view;
    public FragmentElectivesixtyone() {
    }
    private WebView webView60;
    String electivesixtyonetext="<p><b><strong>With the consent of adviser the student will choose any approved*" +
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view =inflater.inflate(R.layout.electivesixtyone_fragment,container,false);
        webView60 = (WebView) view.findViewById(R.id.subsixtyone);
        webView60.loadDataWithBaseURL(null,electivesixtyonetext,"text/html","utf-8",null);

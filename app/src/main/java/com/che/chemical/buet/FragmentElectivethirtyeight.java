...
public class FragmentElectivethirtyeight extends Fragment {
    View view;
    public FragmentElectivethirtyeight() {
    }
    private WebView webView37;
    String electivethirtyeighttext=
            "<p><b><strong>With the consent of adviser the student will choose any approved*" +
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view =inflater.inflate(R.layout.electivethirtyeight_fragment,container,false);
        webView37 = (WebView) view.findViewById(R.id.subthirty_eight);
        webView37.loadDataWithBaseURL(null,electivethirtyeighttext,"text/html","utf-8",null);

...
public class FragmentElectivefiftythree extends Fragment {
    View view;
    public FragmentElectivefiftythree() {
    }
    private WebView webView52;
    String electivefiftythreetext="<p><b><strong>With the consent of adviser the student will choose any approved*" +
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view =inflater.inflate(R.layout.electivefiftythree_fragment,container,false);
        webView52 = (WebView) view.findViewById(R.id.subfiftythree);
        webView52.loadDataWithBaseURL(null,electivefiftythreetext,"text/html","utf-8",null);

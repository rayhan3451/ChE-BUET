...
public class FragmentElectivefourtysix extends Fragment {
    View view;
    public FragmentElectivefourtysix() {
    }
    private WebView webView45;
    String electivefourtysixtext="<p><b><strong>With the consent of adviser the student will choose any approved*" +
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view =inflater.inflate(R.layout.electivefourtysix_fragment,container,false);
        webView45 = (WebView) view.findViewById(R.id.subfourtysix);
        webView45.loadDataWithBaseURL(null,electivefourtysixtext,"text/html","utf-8",null);

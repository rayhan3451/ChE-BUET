...
public class FragmentElectivefourtyfive extends Fragment {
    View view;
    public FragmentElectivefourtyfive() {
    }
    private WebView webView44;
    String electivefourtyfivetext="<p><b><strong>With the consent of adviser the student will choose any approved*" +
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view =inflater.inflate(R.layout.electivefourtyfive_fragment,container,false);
        webView44 = (WebView) view.findViewById(R.id.subfourtyfive);
        webView44.loadDataWithBaseURL(null,electivefourtyfivetext,"text/html","utf-8",null);
